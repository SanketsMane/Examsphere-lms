...
import { PricingCards } from "../pricing/_components/pricing-cards";
    ...
    return (
        <div className="p-6 space-y-8">
            ...
            <div className="space-y-4">
                ...
                <PricingCards plans={plans} currentSubscriptionId={subscription?.id} />
             </div>
            ...
            {subscription && subscription.status === 'active' && (
                 <div className="pt-6 border-t">
                    ...
                    <PricingCards 
                        plans={[]}  // Hack to use the internal Cancel Logic if I moved it there, but better to just use a Client Component button here.
                        currentSubscriptionId={subscription.id} 
                        showCancelButton={true} // Need to update PricingCards to accept this or create new component
                    />
                 </div>
            )}
        </div>
